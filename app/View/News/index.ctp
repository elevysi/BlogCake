<div class="news index">
	...
	<tr>
		...
		<td><?php echo h($news['News']['footer']); ?>&nbsp;</td>
		<td><?php echo h($news['News']['created']); ?>&nbsp;</td>
		<td><?php echo h($news['News']['modified']); ?>&nbsp;</td>
		<td><?php echo h($news['News']['record_owner']); ?>&nbsp;</td>
		<td class="actions">
...
<div class="btn-group-vertical">
	<h3><?php echo __('Actions'); ?></h3>
		...
		<?php echo $this->Html->link(__('New News'), array('action' => 'add'), array('class' => 'btn btn-default')); ?>	
</div>

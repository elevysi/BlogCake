...
<div class="btn-group-vertical">
	<h3><?php echo __('Actions'); ?></h3>
		...
		<?php echo $this->Html->link('<span class="glyphicon glyphicon-list-alt"></span> List Responsibles', array('action' => 'index'), array('class' => 'btn btn-md btn-primary', 'escape' => FALSE)); ?>	
</div>

...
<div class="btn-group-vertical">
	<h3><?php echo __('Actions'); ?></h3>
		...
		<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('User.id')), array('class' => 'btn btn-danger', 'escape' =>FALSE), __('Are you sure you want to delete # %s?', $this->Form->value('User.id'))); ?>		<?php echo $this->Html->link(__('List Users'), array('action' => 'index'), array('class' => 'btn btn-default', 'escape' =>FALSE)); ?></div>

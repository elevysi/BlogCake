<div class="messages index">
	...
	<tr>
		...
		<td><?php echo h($message['Message']['object']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['sender']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['recipients']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['body']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['created']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['modified']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['show']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['record_owner']); ?>&nbsp;</td>
		<td class="actions">
...
<div class="btn-group-vertical">
	<h3><?php echo __('Actions'); ?></h3>
		...
		<?php echo $this->Html->link(__('New Message'), array('action' => 'add'), array('class' => 'btn btn-default')); ?>	
</div>
